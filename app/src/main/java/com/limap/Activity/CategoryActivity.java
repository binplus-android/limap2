...
public class CategoryActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       datumList1=new ArrayList<>();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_favorite:
                        Intent b = new Intent(CategoryActivity.this, MyFavoriteActivity.class);
                        startActivity(b);
                        break;
                    case R.id.navigation_sell:
                        Intent c = new Intent(CategoryActivity.this, CheckPostActivity.class);
                        startActivity(c);
                        break;
                    case R.id.navigation_adds:
                        Intent a = new Intent(CategoryActivity.this,MyPostAdvertisementActivity.class);
                        startActivity(a);
                        break;
                    case R.id.navigation_account:
                        Intent d = new Intent(CategoryActivity.this,CheckAccountActivity.class);
                        startActivity(d);
                        break;
                }
                return false;
        ...
        navigation1.getMenu().findItem(R.id.navigation_home).setChecked(true);
        navigation1.getMenu().performIdentifierAction(R.id.navigation_home, 0);
                        ...
                        switch (statusCode)
                        {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try
                                {
                                    ...
                                    rae.startResolutionForResult(CategoryActivity.this, REQUEST_CHECK_SETTINGS);
                                }
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(CategoryActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
                        updateLocationUI();
                    }
                });
